...
extern uint32_t i2c_Config_Request(TS_I2C_INFO *i2c_data);
extern uint32_t i2c_Receive_Data_Request(TS_I2C_INFO *i2c_data, uint8_t *rcv_buff, uint32_t rcv_length);
extern uint32_t i2c_Send_Data_Request(TS_I2C_INFO *i2c_data, uint8_t *snd_buff, uint32_t snd_length);
extern uint32_t i2c_Tx_Rx_Data_Request(TS_I2C_INFO *i2c_data, uint8_t *snd_buff, uint32_t snd_length, uint8_t *rcv_buff, uint32_t rcv_length);
